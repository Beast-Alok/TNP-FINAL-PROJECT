...
SECRET_KEY = 'django-insecure-q(c&)(#d4^9s7g(pl(5dme&ph4hw@w3y8lr8%@2bicpp-!h9r^'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'alokraghuwanshi2004@gmail.com'
EMAIL_HOST_PASSWORD = 'potuwtlrgoicshtf'  # Use App Password if using Gmail
